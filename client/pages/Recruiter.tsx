...
export default function Recruiter() {
  ...
  useEffect(() => {
    ...
    // Load applications (for now we'll use mock data but in real app this would come from API)
    const mockApplications = [
      {
        id: 1,
        jobId: savedJobPosts[0]?.id || 1,
        jobTitle: savedJobPosts[0]?.title || "Software Developer",
  ...
  return (
    <div className="min-h-screen bg-slate-50">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="flex">
          {/* Sidebar */}
          <aside className="w-64 bg-white rounded-lg shadow-sm border border-slate-200 h-fit">
            <div className="p-6">
