    ...
    <div className="min-h-screen bg-gradient-to-b from-white via-slate-50 to-white text-slate-900 antialiased">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-16 flex items-center justify-between">
          <div className="flex items-center gap-3">
            <motion.div
              ...
              className="w-9 h-9 rounded-full bg-gradient-to-r from-blue-600 via-purple-600 to-pink-600 grid place-items-center shadow-md"
            >
      ...
      <section className="relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-20 pb-16 sm:pt-24 sm:pb-24">
          ...
          >
            JobMatch AI revolutionizes job searching with intelligent matching,
      ...
      <section className="py-20">
        <div className="max-w-4xl mx-auto text-center px-4 sm:px-6 lg:px-8">
          ...
          >
            Join thousands of professionals who trust JobMatch AI to accelerate
            their careers.
          </motion.p>
          <motion.div
            {...fadeUp(0.3)}
