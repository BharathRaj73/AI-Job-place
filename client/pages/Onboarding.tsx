      ...
      <Card className="w-full max-w-2xl border-0 shadow-2xl rounded-2xl overflow-hidden">
        <CardHeader className="text-center pb-8">
          <motion.div
            ...
            className="w-16 h-16 mx-auto mb-4 bg-gradient-to-r from-sky-500 to-indigo-500 rounded-full flex items-center justify-center shadow-lg"
          >
          ...
          <p className="text-gray-500 mt-2 text-lg">
            Personalize your JobMatch experience
          </p>
        </CardHeader>
