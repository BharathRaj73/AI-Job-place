        ...
        <header className="bg-white/80 backdrop-blur-md shadow-md border-b border-slate-200">
          <div className="max-w-6xl mx-auto px-6 py-4 flex items-center gap-4">
            ...
            <div className="flex items-center gap-2">
              <div className="w-8 h-8 bg-gradient-to-tr from-sky-500 to-indigo-500 rounded-full flex items-center justify-center">
                <Brain className="w-4 h-4 text-white" />
              </div>
              <span className="text-xl font-bold text-slate-800">JobMatch AI</span>
            </div>
          </div>
        </header>
